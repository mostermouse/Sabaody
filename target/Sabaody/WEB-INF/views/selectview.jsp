			...
			<div class='sub_titimg'>
				<ul>
					...
					<li class='p_t5' style="font-size: 20px;">
						給与に関連する勤怠記録を管理するメニューです。社員別勤務履歴を管理できます。</li>
				</ul>
						...
						<ul>
							<div id='table0'>
								...
								<ul class='c' id="btnGroup">
									<li id="grpBtn01">
										<button type="submit" alt="保存" title="保存" onclick="return validateForm();">保存</button>
									...
									<li id="grpBtn02" class="disHide">
										<button type="submit" name="btnDlgnSaveUpd"
											id="btnDlgnSaveUpd" alt="修正" title="修正">修正</button>
