    ...
    <div id="top_gnb_2017">
        <div class="navi_2017">
            <ul class="navi_L_2017">
                <li class="n01">
                    <button onclick="location.href='/SelectStatusServlet'"
                            title="[Shift + 1] HOME">
                        <span id="SK01">勤怠管理</span>
                    </button>
                </li>
                <li class="n02">
                    <button onclick="location.href='/employee'"
                            title="[Shift + 2] 社員登録">
                ...
                <li class="n06">
                    <button onclick="location.href='/vacationselect'"
                            title="[Shift + 6] 休暇照会">
                ...
                <li class="n08">
                    <button onclick="location.href='/dayselect'"
                            title="[Shift + 8] 休暇修正">
                        ...
                        <div id='table_dil'>
                            ...
                            <div id="disContentList" class="disContentList"
                                ...
                                <div id="table_dil_data">
                                        <table>
                                            <c:forEach var="employmentStatus" items="${employmentStatusList}">
                                                <tr>
                                                    <li class="w_24" style="text-align: center;"><label class="label_check" for="grpEmployeeInfoId"><input
                                                            ...
                                                            value="${employmentStatus.id}"></label></li>
                                                    <li class="w_100" style="text-align: center;">${employmentStatus.division}</li>
                                                    <li class="w_105" style="text-align: center;">${employmentStatus.id}</li>
                                                    <li class="w_100" style="text-align: center;">${employmentStatus.name}</li>
                                                    <li class="w_120" style="text-align: center;">${employmentStatus.department}</li>
                                                    <li class="w_120" style="text-align: center;">${employmentStatus.position}</li>
                                                    <li class="w_119" style="text-align: center;">
                                                    <form action="/deleteEmployee" method="post">
                                                        <input type="hidden" name="employeeId" value="${employmentStatus.id}">
...
<script>
        ...
        form.setAttribute("action", "/deleteEmployee");
        form.style.display = "none"; // 폼을 화면에 보이지 않도록 설정

        // 직원 ID를 전송하는 hidden input 요소 생성
                    ...
                    <ul>
                        <div id='table0'>
                            ...
                            <ul id="disLeavItemExpire" class="disHide">
                                ...
                                <li class='con'><input name="frmDlsvSttDExpire"
                                                       id="frmDlsvSttDExpire" type="text" value="" class="white"
                                                       style="width: 80px; color: #eb4e5d;" READONLY> ~ <input
                                        name="frmDlsvEndDExpire" id="frmDlsvEndDExpire" type="text"
                                        value="" class="white" style="width: 80px; color: #eb4e5d;"
                                        READONLY></li>
                            </ul>
                            <ul>
                                <li class='w_135 c'><strong>期間</strong></li>
                                <li class='con'><input name="frmDlsvSttD" id="frmDlsvSttD"
                                                       type='text' placeholder='開始日' class='text'
                                                       style="width: 80px;" maxlength="10"> ~ <input
                                        name="frmDlsvEndD" id="frmDlsvEndD" type='text'
                                        placeholder='終了日' class='text' style="width: 80px;"
                                        maxlength="10"></li>
                            </ul>
                            <ul>
                                <li class='w_135 c'><strong><span
                                        id="disDlgnDays">勤労日数</span></strong></li>
                                <li class='con'><input name="frmDlsvDays" id="frmDlsvDays"
                                                       type='text' placeholder='勤労日数' class='text'
                                                       style='width: 80px;' maxlength="5"> <span
                                        id="disDlsvUnit">仕事</span>&nbsp;&nbsp;
                                    <div class='p_t3 f_right'>
                                        <form name="btnHolidayTotalForm" id="btnHolidayTotalForm"
                                              method="post" action="your_action_url">
                                            <input type="submit" name="btnHolidayTotal"
                                                   id="btnHolidayTotal" value="休暇日数の現状" class="anchor">
                                        </form>
                                    </div>
                                </li>
                            </ul>
                            <ul>
                                ...
                                <li class='con'><input name="frmDlsvPays" id="frmDlsvPays"
                                                       type='text' value='' class='white clsAmount'
                                                       style='width: 210px; color: #eb4e5d; text-align: right;'
                                                       placeholder="* 勤怠分類が支払手当に該当する場合"></li>
                            </ul>
                            <ul>
                                <li class='w_135 c'><strong>摘要</strong></li>
                                <li class='con'><input name="frmDlsvEtcs" id="frmDlsvEtcs"
                                                       type='text' value='' class='white' style='width: 190px;'
                ...
                <script>
                    function validateForm() {
                        var inputdate = document
                            .getElementById('inputdate').value;
                        var employeeId = document
                            .getElementById('employeeId').value;
                        var frmDlgnCode = document
                            .getElementById('frmDlgnCode').value;
                        var frmDlsvSttD = document
                            .getElementById('frmDlsvSttD').value;
                        var frmDlsvEndD = document
                            .getElementById('frmDlsvEndD').value;
                        var frmDlsvDays = document
                            .getElementById('frmDlsvDays').value;
                        var frmDlsvPays = document
                            .getElementById('frmDlsvPays').value;
                        var frmDlsvEtcs = document
                            .getElementById('frmDlsvEtcs').value;
