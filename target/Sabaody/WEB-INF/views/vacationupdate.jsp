	...
	<div class="registration-container">
	 ...
	 <script>
      function validateForm() {
         ...
         var vacationitem = document.getElementById("vacationitem").value;
         var vacationtype = document.getElementById("vacationtype").value;
         var usedvacation = document.getElementById("usedvacation").value;
         var remaining = document.getElementById("remaining").value;

         if (id === "" || vacationitem === "" || vacationtype === ""
